...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    group.bench_function("fpdec_quote_convert_from".to_string(), |b| {
        b.iter(|| {
            let qty = Dec!(5);
            let price = Dec!(100);
    ...
    group.bench_function("const_decimal_i32_quote_convert_from".to_string(), |b| {
        b.iter(|| {
    ...
    group.bench_function("fpdec_base_convert_from".to_string(), |b| {
        b.iter(|| {
            let qty = Dec!(500);
            let price = Dec!(100);
            let _ = black_box(qty / price);
    ...
    group.bench_function("const_decimal_i32_base_convert_from".to_string(), |b| {
        b.iter(|| {
            let qty = const_decimal::Decimal::<i32, 2>::try_from_scaled(5, 0).unwrap();
            let price = const_decimal::Decimal::<i32, 2>::try_from_scaled(100, 0).unwrap();
            let _ = black_box(qty / price);
    ...
    group.bench_function("fpdec_linear_futures_pnl".to_string(), |b| {
        b.iter(|| {
    ...
    group.bench_function("const_decimal_i32_linear_futures_pnl".to_string(), |b| {
        b.iter(|| {
    ...
    group.bench_function("const_decimal_i64_linear_futures_pnl".to_string(), |b| {
        b.iter(|| {
    ...
    group.bench_function("fpdec_inverse_futures_pnl".to_string(), |b| {
        b.iter(|| {
            let entry_price = Dec!(100);
            let exit_price = Dec!(110);
            let qty = Dec!(500);
    ...
    group.bench_function("const_decimal_i32_inverse_futures_pnl".to_string(), |b| {
        b.iter(|| {
            let entry_price = const_decimal::Decimal::<i32, 2>::try_from_scaled(100, 0).unwrap();
            let exit_price = const_decimal::Decimal::<i32, 2>::try_from_scaled(110, 0).unwrap();
    ...
    group.bench_function("const_decimal_i64_inverse_futures_pnl".to_string(), |b| {
        b.iter(|| {
            let entry_price = const_decimal::Decimal::<i64, 2>::try_from_scaled(100, 0).unwrap();
