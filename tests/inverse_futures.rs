...
fn inv_long_market_win_full() {
    ...
    let _ = exchange.update_state(1, bba!(quote!(1000.0), quote!(1001.0))).unwrap();
...
fn inv_long_market_loss_full() {
    ...
    let _ = exchange.update_state(2, bba!(quote!(800.0), quote!(801.0))).unwrap();
...
fn inv_short_market_win_full() {
    ...
    let _ = exchange.update_state(1, bba!(quote!(799.0), quote!(800.0))).unwrap();
    assert_eq!(exchange.account().position().unrealized_pnl(), base!(0.2));
    ...
    let _ = exchange.update_state(2, bba!(quote!(799.0), quote!(800.0))).unwrap();
...
fn inv_short_market_loss_full() {
    ...
    let acc_tracker = NoAccountTracker::default();
    let mut exchange = Exchange::new(acc_tracker, config);
    let _ = exchange.update_state(0, bba!(quote!(1000), quote!(1001))).unwrap();
    ...
    let _ = exchange.update_state(1, bba!(quote!(999), quote!(1000))).unwrap();
    ...
    let _ = exchange.update_state(2, bba!(quote!(1999), quote!(2000))).unwrap();
    ...
    let _ = exchange.update_state(3, bba!(quote!(1999.0), quote!(2000.0))).unwrap();
...
fn inv_long_market_win_partial() {
    ...
    let _ = exchange.update_state(2, bba!(quote!(2000.0), quote!(2001.0))).unwrap();
...
fn inv_long_market_loss_partial() {
    ...
    let _ = exchange.update_state(1, bba!(quote!(800.0), quote!(801.0))).unwrap();
    assert_eq!(exchange.account().position().unrealized_pnl(), base!(-0.2));
...
fn inv_short_market_win_partial() {
    ...
    exchange.submit_order(o).unwrap();
    let _ = exchange.update_state(3, bba!(quote!(799.0), quote!(800.0))).unwrap();
...
fn inv_short_market_loss_partial() {
    ...
    let _ = exchange.update_state(1, bba!(quote!(1999.0), quote!(2000.0))).unwrap();
...
fn inv_test_market_roundtrip() {
    ...
    let _ = exchange.update_state(2, bba!(quote!(1000.0), quote!(1001.0))).unwrap();
    ...
    let buy_order = Order::market(Side::Buy, size).unwrap();
    exchange.submit_order(buy_order).unwrap();
    let _ = exchange.update_state(3, bba!(quote!(1000.0), quote!(1001.0))).unwrap();
    ...
    let _ = exchange.update_state(4, bba!(quote!(998.0), quote!(1000.0))).unwrap();
