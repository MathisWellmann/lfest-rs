...
fn inv_test_market_roundtrip() {
    ...
    exchange.update_state(1000.0, 1000.0, 2);
    ...
    let order_err = exchange.submit_order(buy_order);
    assert!(order_err.is_ok());
    exchange.update_state(1000.0, 1000.0, 3);
    ...
    exchange.update_state(1000.0, 1000.0, 4);
